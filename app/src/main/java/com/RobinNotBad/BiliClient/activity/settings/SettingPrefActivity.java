...
public class SettingPrefActivity extends RefreshListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final List<SettingSection> sectionList = new ArrayList<>() {{
            ...
            add(new SettingSection("switch", "请求JPG格式图片", "image_request_jpg", getString(R.string.desc_img_request_jpg), String.valueOf(com.RobinNotBad.BiliClient.util.GlideUtil.defaultRequestJpg())));
